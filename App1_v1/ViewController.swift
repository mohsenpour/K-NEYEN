...
//  App1_v1
//
//  Created by Mohamed Eid on 2020-01-04.
...
//        togglePulse(pulse: false)
        ...
        performSegue(withIdentifier: "open_camera", sender: Any?.self)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "open_camera" {
            let controller = segue.destination as! CameraViewController
            
            controller.spokenText = transcribedTextView.text
